...
class DeleteAllNotification @Inject constructor(private val notificationRepo: NotificationRepository)  {
     suspend fun execute(data: List<Notification>) = notificationRepo.deleteAll(data)
}