...
class InsertNotification @Inject constructor(private val notificationRepo: NotificationRepository) {
     suspend fun execute(data: Notification) = notificationRepo.insert(data)
}